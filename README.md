...
========================================================
This logger writes a text file with data and timestamps to a SD-card.
...
2. To set the Adafruit Feather 32u4 Adalogger #2795 up 
for the preferred charging current of 400 mA by replacing R0 on the Feather board with a 2k2 SMD 0805 resistor. Otherwise, the default charging current is 100 mA, which requires four times the charging time.
...
9. You may like to try the newer and software compatible sensor type TMP119.
...
Adaption of an Openlog board for precision temperature logging requires microscope soldering and trace cutting.
