...
&emsp;&emsp;You may have to **double-click** the RST button to get into the bootloader. You need to\
&emsp;&emsp; install avrdude for this. If you choose this option, you do not need to install and operate the Arduino IDE and libraries.
