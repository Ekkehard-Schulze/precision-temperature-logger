Notes
-----
**This Arduino firmware sets the time of the DS3231 to the compile time of the script**

So, compile and upload the switch. Typically, after the upload the microcontroller restarts
